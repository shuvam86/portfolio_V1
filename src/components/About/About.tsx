    ...
    <Container id="about">
      <div className="about-text">
        ...
        <ScrollAnimation animateIn="fadeInLeft" delay={0.1 * 1000}>
          <p>
          I am an experienced Full Stack Developer proficient in Javascript, NodeJs, VueJs, ReactJs, Appscript and C++. With a keen eye for detail, I excel in delivering exceptional results that surpass client expectations. My commitment lies in leveraging my skills to provide cutting-edge solutions for business success.
          </p>
        </ScrollAnimation>
        <ScrollAnimation animateIn="fadeInLeft" delay={0.2 * 1000} style={{ marginTop: "2rem", marginBottom: "2rem" }}>
          <p>
          Passionate about technology, I continuously seek growth to stay ahead of emerging trends. Collaboration is integral to my approach as I believe diverse talents drive remarkable outcomes. I am open to new opportunities where I can apply my expertise effectively. 
            </p>
        </ScrollAnimation>
        <ScrollAnimation animateIn="fadeInLeft" delay={0.3 * 1000}>
          <p>
          Let's connect and explore how we can achieve extraordinary results together!
        </p>
        </ScrollAnimation>
